...
```{r}
ggplot(gather(select(d, COMM_log)), 
       mapping = aes(x = value)) +
  geom_density() +
  facet_wrap(~key, nrow=1) + 
  theme_bw()
...
d %<>%
  mutate(pri_con_fs_c = scale(pri_con_fs, scale = FALSE),
...
corr_plot <- ggpairs(select(d_fs, -version),
...
d_sub <- d[, c("COMM", "GR02_01", "GR02_02", "GR02_03", "GR02_04", "GR02_05", "PC01_01", "PC01_02", "PC01_04", "PC01_05", "PC01_06", "PC01_07", "TR01_02", "TR01_03", "TR01_04", "TR01_06", "TR01_07", "TR01_08", "TR01_10", "TR01_11", "TR01_12", "PD01_01", "PD01_02", "PD01_03", "PD01_04", "PD01_05", "SE01_01", "SE01_02", "SE01_03", "SE01_04", "male", "age", "edu")]
...
```{r}
fit_brms <- brm(COMM ~ pri_con_fs_c * grats_spec_fs_c + pri_con_fs_c * pri_del_fs_c + grats_spec_fs_c * pri_del_fs_c, data = d, family = zero_inflated_poisson())
summary(fit_brms)
```
