...
packages <- c("cowplot", "devtools", "faoutlier", "GGally", "gganimate",
              ...
              "quanteda", "semTools", "tidyverse")

# install packages # uncomment lines to install packages
...
We've also inspected the data manually for cases with clear response patterns. The following cases show extreme response patterns, fast response times, and were hence removed.
...
save(d, d_raw, d_all, d_fs,
     ...
     n_users, n_final,
     infl_cases, infl_cases_tokens, resp_pattern, n_resp_pattern,
