...
author_note: |
    ...
    This manuscript features a companion website, which includes the data, code, additional analyses, and a reproducible version of the manuscript (https://tdienlin.github.io/privacy_calc_exp).
abstract: |
...
Still missing is a long-term field study in which actual behavior is observed in an authentic context. 
...
Introducing the option to receive likes thereby affords and emphasizes a _gain frame_
(see also @rosoffHeuristicsBiasesCyber2013). 
These gains can be garnered only through participation. 
In addition, because positive outcomes are emphasized, it is likely that concerns decrease. 
Finally, in situations where there is more to win, one needs to deliberate whether one wants to partake.
Implementing like buttons might therefore also make people more actively deliberate about whether or not to disclose information. 
...
The online supplementary material (OSM) of this study includes the data, research materials, analyses scripts, and a reproducible version of this manuscript, which can be found on the manuscript's companion website (https://tdienlin.github.io/privacy_calc_exp).
...
Unfortunately, the data of several participants could not be matched for technical reasons, for example because they used different devices for the respective steps.
...
To detect potentially corrupt data, we calculated Cook's distance.
...
Although the effect seems substantial, one could argue that it should be higher and that more people in our society should actively deliberate about their self-disclosure practices online. 
...
Instead, the results only suggest that there exist certain situations and instances in which the influence of popularity cues is negligible.
